...
const Time = () => {
    ...
    const ButtonConstructor = ({ name, colorBgc, colorText }) => <button
            style={ {backgroundColor: colorBgc, marginRight: '22px', color: colorText} }
            onClick={ () => {setColor(colorBgc); setClock(true)} }>
                { name }
            </button>
    ...
    return (
        <div className={css.time}>
            ...
            <ButtonConstructor name='LIGHT BLUE'  colorBgc='dodgerblue'  colorText='white' />
